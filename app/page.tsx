...
export const metadata: Metadata = {
  title: 'Minko — Explore motion as it unfolds through time',
  ...
  return (
    <SiteShell>
      <main id="main-content">
        <section className="site-hero">
          ...
          <div className="site-wrap site-hero-grid">
            <div className="site-hero-copy">
              ...
              <h1>Explore motion <br />as it unfolds <br /><em>through time.</em></h1>
        ...
        <section className="site-section site-namesake-section" id="minkowski">
          <div className="site-wrap">
            <div className="site-namesake-heading" data-reveal>
              <p className="site-eyebrow">THE NAME BEHIND MINKO</p>
              <h2>Hermann Minkowski made space and time visible together.</h2>
              <p>His 1908 lecture described an event as a place at a particular time, and a moving object&apos;s history as a worldline. Minko takes visual inspiration from that idea—it does not simulate relativity.</p>
            </div>
            <div className="site-namesake-grid" data-reveal>
              <figure className="site-minkowski-portrait">
                <Image src="/images/hermann-minkowski.jpg" alt="Historical portrait of mathematician Hermann Minkowski" width={813} height={1093} sizes="(max-width: 640px) 120px, 190px" />
              ...
              <div className="site-namesake-diagram"><MinkowskiDiagram compact /></div>
              <div className="site-namesake-notes">
                <div><strong>EVENT</strong><span>One position at one time.</span></div>
                <div><strong>WORLDLINE</strong><span>Connected events trace a path through time.</span></div>
                <div><strong>LIGHT CONE</strong><span>Its edges mark light-speed paths from an event.</span></div>
                <Link href="/about#minkowski" className="site-text-link">The story behind Minko <span aria-hidden="true">↗</span></Link>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="site-section site-intro-section" id="how-it-works">
          <div className="site-wrap">
            ...
            <div className="site-process-figure" data-reveal><ProcessArtwork /></div>
            <div className="site-steps">
              <article data-reveal><span className="site-step-index">01 / OPEN</span><h3>Choose a video</h3><p>Use your own file or one of the included demos. Your file stays on your device; Minko processes it in the browser.</p></article>
              <article data-reveal><span className="site-step-index">02 / BUILD</span><h3>Place frames in time</h3><p>Frames become slices of a 3D texture. Detail settings balance the number of slices against processing time and memory.</p></article>
              <article data-reveal><span className="site-step-index">03 / EXPLORE</span><h3>Look through motion</h3><p>Orbit the stack, move the current slice, and compare it with the original video playing alongside it.</p></article>
            </div>
          </div>
        </section>
        ...
        <section className="site-section site-features-section">
          <div className="site-wrap">
            <div className="site-section-heading site-section-heading-split" data-reveal>
            ...
            <div className="site-feature-grid">
              <article className="site-feature-card" data-reveal>
        ...
        <section className="site-final-section">
          <div className="site-wrap site-final-inner" data-reveal><div><p className="site-eyebrow">READY WHEN YOU ARE</p><h2>One video. Another perspective.</h2><p>Open Minko and see what your clip looks like when time becomes visible.</p></div><Link href="/app" className="site-button">Launch the app <span aria-hidden="true">↗</span></Link></div>
        </section>
      </main>
    </SiteShell>
  );
